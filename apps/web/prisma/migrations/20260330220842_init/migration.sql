...
-- CreateIndex
CREATE UNIQUE INDEX "EventSchema_projectId_name_key" ON "EventSchema"("projectId", "name");

-- CreateIndex
CREATE INDEX "Event_projectId_eventName_timestamp_idx" ON "Event"("projectId", "eventName", "timestamp");
